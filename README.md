...
- 📈 My journey until today as a file directory:
      `B. Eng in Electrical and Information Systems`/`M. Eng in Energy Efficiency and Technical Systems`/`JavaScript`/`Freelance Software Engineer`
